...
/**
 *
 * @author turma favorita da Vanessa
 */
public class EncadeamentoInteriorTest {
    ...
    @Before
    public void setUp() {
        instance = new EncadeamentoInterior(7);
    ...
    public void testaCriaTabelaVazia() throws FileNotFoundException, Exception {
        ...
        //Adicionar 7 compartimentos que não apontam para ninguem (prox = i)
        for (int i = 0; i <7; i++) {
            tabHash.add(new Cliente(-1, "          ",i, Cliente.LIBERADO));
        }        

        instance.criaHash(NOME_ARQUIVO_HASH);
